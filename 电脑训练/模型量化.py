...
CONFIG: Dict[str, Any] = {
    ...
    "data_dir": r"D:\ZTT\Garbage Classification\garbage_dataset",

    # 训练好的 best 模型
    # 如果你用的是我前面给你的完整训练脚本，通常是：
    # outputs/latest_mobilenetv3_best.pt
    "ckpt": r"D:\ZTT\Garbage Classification\outputs\latest_mobilenetv3_best.pt",

    # 量化导出目录
    "outdir": r"D:\ZTT\Garbage Classification\export",
