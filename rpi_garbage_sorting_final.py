...
默认项目路径：/home/amina/workspaces/Garbage Classification
...
class FinalGarbageSortingSystem:
    def __init__(self, args):
        ...
        self.mapping_path = Path(args.mapping_path).expanduser().resolve() if args.mapping_path else self.project_root / "class_mapping.json"
...
def parse_args():
    ...
    parser.add_argument("--mapping-path", default="", help="class_mapping.json 路径；为空则使用 project-root/class_mapping.json")
