/* mcu_triggered_rkho_protocol_test.c — 对应 rpi_triggered_ai_sorting_rkho_old.py */
#include <REGX52.H>
...
void main(){UartI(); u16 t=0; u8 ch;
while(1){t++; if(t>=3000){t=0;UartS('T');}
if(rf){rf=0;ch=rx;
if(ch=='R'||ch=='K'||ch=='H'||ch=='O'){DelayMs(500);UartS('D');}
else if(ch=='F'){UartS('N');DelayMs(1000);}
else UartS('E');}
DelayMs(1);}}
